...
import 'calendario_old_model.dart';
export 'calendario_old_model.dart';

class CalendarioOldWidget extends StatefulWidget {
  const CalendarioOldWidget({super.key});

  @override
  State<CalendarioOldWidget> createState() => _CalendarioOldWidgetState();
}

class _CalendarioOldWidgetState extends State<CalendarioOldWidget> {
  late CalendarioOldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CalendarioOldModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final calendarioOldUsersRecord = snapshot.data!;
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              if (currentUserDocument?.role == Role.Teacher) {
                                context.pushNamed('MinhaAgendaTeacher');
                              } else {
                                context.pushNamed('MinhaAgendaPais');
                              }
                            },
                            child: Material(
                              color: Colors.transparent,
