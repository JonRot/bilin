...
import 'minha_agenda_admin_copy_model.dart';
export 'minha_agenda_admin_copy_model.dart';

class MinhaAgendaAdminCopyWidget extends StatefulWidget {
  const MinhaAgendaAdminCopyWidget({super.key});

  @override
  State<MinhaAgendaAdminCopyWidget> createState() =>
      _MinhaAgendaAdminCopyWidgetState();
}

class _MinhaAgendaAdminCopyWidgetState extends State<MinhaAgendaAdminCopyWidget>
    with TickerProviderStateMixin {
  late MinhaAgendaAdminCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MinhaAgendaAdminCopyModel());
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return AppointmentCardWidget(
                                      key: Key(
                                          'Keyxb6_${listViewIndex}_of_${listViewAppointmentsRecordList.length}'),
                                        ...
                                        return Column(
                                          ...
                                          children: List.generate(unique.length,
                                            ...
                                            return PresencaCardWidget(
                                              key: Key(
                                                  'Keygve_${uniqueIndex}_of_${unique.length}'),
