...
import 'notification_form_model.dart';
export 'notification_form_model.dart';

class NotificationFormWidget extends StatefulWidget {
  const NotificationFormWidget({super.key});
...
class _NotificationFormWidgetState extends State<NotificationFormWidget>
  ...
  late NotificationFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificationFormModel());
