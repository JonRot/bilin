...
import '/messages/comp/chat_thread_update/chat_thread_update_widget.dart';
        ...
        children: [
          Expanded(
            child: StreamBuilder<List<ChatMessagesRecord>>(
              stream: FFAppState().chatMessaging(
                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadUpdateWidget(
                          key: Key(
                            'Keyv79_${listViewChatMessagesRecord.reference.id}',
                          ),
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (_model.uploadedFileUrl1 != '') {
                                _model
                                    .addToImagesUploaded(valueOrDefault<String>(
                                  _model.uploadedFileUrl1,
                                  'photoURL',
                                ));
                                safeSetState(() {});
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  onFieldSubmitted: (_) async {
                                    ...
                                    // addMyUserToList
                                    _model
                                        .addToLastSeenBy(currentUserReference!);
                                    // updateChatDocument
                                    ...
                                    safeSetState(() {});
                                    FFAppState().clearChatMessagingCacheKey(
                          ...
                          if ((_model.textController.text == '') ||
                              !(_model.imagesUploaded.isNotEmpty))
                            Align(
