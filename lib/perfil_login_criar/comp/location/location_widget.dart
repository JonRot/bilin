                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      var cidadeRecordReference = CidadeRecord.collection.doc();
                      await cidadeRecordReference.set(createCidadeRecordData(
                        cidade: widget.cidade != null && widget.cidade != ''
                            ? widget.cidade
                            : _model.cidadeTextController.text,
                        estado: widget.estado != null && widget.estado != ''
                            ? widget.estado
                            : _model.estadoTextController.text,
                        cep: widget.cep,
                        nomeRua:
                            '${_model.ruaTextController.text} ${_model.numeroTextController.text}',
                        enderecoCompleto:
                            '${_model.ruaTextController.text} ${_model.numeroTextController.text} - ${_model.uniTextController.text != '' ? '${_model.uniTextController.text} - ' : ''}${_model.bairroTextController.text} - ${_model.cidadeTextController.text} - ${_model.estadoTextController.text} - ${widget.cep}',
                        userRefCidade: currentUserReference,
                        titulo: _model.tituloTextController.text,
                        bairro: widget.bairro != null && widget.bairro != ''
                            ? widget.bairro
                            : _model.bairroTextController.text,
                        uni: _model.uniTextController.text,
                        numero: int.tryParse(_model.numeroTextController.text),
                        latLong: widget.latLng,
                      ));
                      _model.createdLocation = CidadeRecord.getDocumentFromData(
                          createCidadeRecordData(
                            cidade:
                                widget.cidade != null && widget.cidade != ''
                                    ? widget.cidade
                                    : _model.cidadeTextController.text,
                            estado:
                                widget.estado != null && widget.estado != ''
                                    ? widget.estado
                                    : _model.estadoTextController.text,
                            cep: widget.cep,
                            nomeRua:
                            ...
                            titulo: _model.tituloTextController.text,
                            bairro:
                                widget.bairro != null && widget.bairro != ''
                                    ? widget.bairro
                                    : _model.bairroTextController.text,
                            uni: _model.uniTextController.text,
                            numero:
                                int.tryParse(_model.numeroTextController.text),
                            latLong: widget.latLng,
                          ),
                          cidadeRecordReference);

                      await _model.createdLocation!.userRefCidade!.update({
                        ...mapToFirestore(
                          {
                            'userRefLocation': FieldValue.arrayUnion(
                                [_model.createdLocation?.reference]),
                          },
                        ),
                      });
