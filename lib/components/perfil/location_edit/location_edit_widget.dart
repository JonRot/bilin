                ...
                children: [
                  ...
                  StreamBuilder<List<CidadeRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<CidadeRecord> buttonCidadeRecordList =
                          snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final buttonCidadeRecord =
                          buttonCidadeRecordList.isNotEmpty
                              ? buttonCidadeRecordList.first
                              : null;
                      ...
                      return FFButtonWidget(
                        onPressed: () async {
                          ...
                          await buttonCidadeRecord!.reference
                              .update(createCidadeRecordData(
