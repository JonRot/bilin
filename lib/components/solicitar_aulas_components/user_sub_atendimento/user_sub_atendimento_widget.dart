...
import 'user_sub_atendimento_model.dart';
export 'user_sub_atendimento_model.dart';

class UserSubAtendimentoWidget extends StatefulWidget {
  const UserSubAtendimentoWidget({
    super.key,
    this.userRef,
    this.action,
  });
  ...
  @override
  State<UserSubAtendimentoWidget> createState() =>
      _UserSubAtendimentoWidgetState();
}

class _UserSubAtendimentoWidgetState extends State<UserSubAtendimentoWidget> {
  late UserSubAtendimentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserSubAtendimentoModel());
  }
